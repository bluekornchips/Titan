...
import {IOffersERC721, OffersERC721} from "Lily/marketplace/offers/OffersERC721.sol";
...
contract OffersERC721_Test is Test, IOffersERC721_Test {
    ...
    function setUp() public {
        ...
        lilyERC721.setBurnEnabled(false);

        // Offers Setup
        offers = new OffersERC721();
        offers.setVendorStatus(address(lilyERC721), true);
    }
    ...
    function test_createOffer_ValueLTEZero_ShouldFail() public {
        ...
        offers.createItemOffer{value: 0}(address(lilyERC721), tokenId);
    }
    ...
    function test_createOffer_CannotBeFromZeroAddress_ShouldFail() public {
        ...
        vm.prank(address(0));
        offers.createItemOffer{value: 1 ether}(address(lilyERC721), tokenId);
    }
    ...
    function test_outbidOffer_ValueGTExistingOffer_ShouldPass() public {
        ...
        offers.createItemOffer{value: 2 ether}(address(lilyERC721), tokenId);
    ...
    function test_acceptOffer_ItemDoesNotExist_ShouldFail() public {
        ...
        offers.acceptItemOffer(address(lilyERC721), 1);
    }
    ...
    function test_acceptOffer_NotTokenOwner_ShouldFail() public {
        ...
        vm.expectRevert(ILilyMarketplaceERC721.NotTokenOwner.selector);
        offers.acceptItemOffer(address(lilyERC721), 1);
    }
    ...
    function test_acceptOffer_ShouldPass() public {
        ...
        IERC721(lilyERC721).approve(address(offers), tokenId);
        ...
        offers.acceptItemOffer(address(lilyERC721), tokenId);
        console.log("sellerBalanceAfter", w_main.balance);
        assertEq(IERC721(lilyERC721).ownerOf(tokenId), w_one);
    ...
    function test_cancelOffer_NotOwner_ShouldFail() public {
        ...
        offers.cancelItemOffer(address(lilyERC721), tokenId);
    }

    function test_cancelOffer_ToNonPayable_ShouldFail() public {
        vm.deal(address(lilyERC721), 1 ether);

        uint32 tokenId = mintAndApprove();

        vm.startPrank(address(lilyERC721));
    ...
    function test_createCollectionOffer_NoValueSent_ShouldRevert() public {
        vm.expectRevert(IOffersERC721.OfferCannotBeLTEZero.selector);
        offers.createCollectionOffer(address(lilyERC721));
    }
        ...
        public
    {
        ...
        vm.expectRevert(IOffersERC721.OfferorCannotBeZeroAddress.selector);
        vm.prank(address(0));
        offers.createCollectionOffer{value: 1 ether}(address(lilyERC721));
    }
    ...
    function test_newCollectionOffer_ShouldPass() public {
        ...
        offers.createCollectionOffer{value: offerValue}(address(lilyERC721));
    ...
    function testFuzz_createCollectionOffer_ShouldPass(
        ...
        do {
            ...
            offers.createCollectionOffer{value: value}(address(lilyERC721));
    ...
    // forge test --match-path test/lily/marketplace/offers/OffersERC721.t.sol --match-test testFuzz_cancelCollectionOffer_ShouldPass -vvv
        ...
        public
    {
        offers.setVendorStatus(address(lilyERC721), true);
        vm.expectRevert(IOffersERC721.OfferDoesNotExist.selector);
        offers.cancelCollectionOffer(address(lilyERC721), 1);
    }
        ...
        public
    {
        ...
        vm.prank(w_one);
        offers.cancelCollectionOffer(address(lilyERC721), 0);
    }
    ...
    //             value: value
    //         });
    //         offers.cancelCollectionOffer(address(lilyERC721), index);
    ...
    // forge test --match-path test/lily/marketplace/offers/OffersERC721.t.sol  -vvv
    ...
    function test_cancelCollectionOffers_EmptyCollection_ShouldRevert() public {
        ...
        offers.cancelCollectionOffers(address(lilyERC721));
    }
    ...
    function test_cancelCollectionOffers_FiftyOffers_ShouldRevert() public {
        ...
        do {
            ...
            assertEq(
                offers.getCollectionOffers(address(lilyERC721)).length,
                i
            );
        } while (i < offerCount);
        ...
        assertEq(offers.getCollectionOffers(address(lilyERC721)).length, 0);
    }
    ...
    function mintAndApprove() internal returns (uint32) {
        ...
        lilyERC721.approve(address(offers), tokenId);
        return tokenId;
    }
    //#endregion
}
