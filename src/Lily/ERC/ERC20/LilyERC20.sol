...
import {ILilyERC20} from "./ILilyERC20.sol";

contract LilyERC20 is
    ILilyERC20,
    ERC20,
    ERC20Burnable,
    ERC20Capped,
...
{
    /**
     * @notice Constructor to initialize the LilyERC20 token
     ...
     * @param amount The amount of tokens to be minted
     */
    function lilyMint(address to, uint256 amount) internal whenNotPaused {
