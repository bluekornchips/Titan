...
const main = async (inputArgs: any): Promise<void> => {
    ...
    if (inputArgs.marketplace) {
        ...
        try {
            ...
            await nonClient.coordinator.marketplace.setAllowedContracts(contracts[VALID_CONTRACTS.Lily.Marketplace.EscrowERC721], contractsToBeCoordinated, VALID_CONTRACTS.Lily.Marketplace.EscrowERC721);
        } catch (error) {
